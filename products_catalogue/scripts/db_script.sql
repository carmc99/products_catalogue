...
CREATE TABLE Catalogue.dbo.Categories (
...
CREATE TABLE Catalogue.dbo.Products (
    Id UNIQUEIDENTIFIER PRIMARY KEY,
    Name NVARCHAR(MAX) NOT NULL,
    Description NVARCHAR(MAX) NULL,
...
INSERT INTO Catalogue.dbo.Categories (Id, Name, Description, CreatedDate, UpdatedDate)
...
INSERT INTO Catalogue.dbo.Catalogue.dbo.Categories (Id, Name, Description, CreatedDate, UpdatedDate)
...
INSERT INTO Catalogue.dbo.Products (Id, Name, Description, CategoryId, Image, CreatedDate, UpdatedDate)
...
INSERT INTO Catalogue.dbo.Catalogue.dbo.Products (Id, Name, Description, CategoryId, Image, CreatedDate, UpdatedDate)
